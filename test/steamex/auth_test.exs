defmodule Steamex.AuthTest do
  ...
  test "auth_url" do
    assert auth_url(@valid_realm, @valid_return_to) ==
             "https://steamcommunity.com/openid/login?openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.mode=checkid_setup&openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0&openid.realm=http%3A%2F%2Fexample.com&openid.return_to=http%3A%2F%2Fexample.com%2Fusers%2Fauth%2Fsteam%2Fcallback"
  end
  ...
  test "validate_payload_success" do
    assert 76_561_197_961_358_433 == validate_payload(@payload, SuccessHTTPoison)
  end
end
